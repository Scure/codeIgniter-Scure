...
<body>
  	...
  	<div style="margin-top:100px; margin-left:10%;">
		  ...
		  <h1 style="margin-top:0px; color:#EEEEE; font-family: 'Source Sans Pro', sans-serif; font-size:65px; font-weight:200; display:none;" id="hero_title" >Security made simple.</h1>
		  <br><br>
		  <p style=" width: 45%; font-family:'Source Sans Pro',sans-serif; color:black; display:none;" id="product_desc">
		  	We're working on the simplest way to help you keep an eye on things at home.  
		  </p>
		  <p style="color:black; font-family:'Source Sans Pro',sans-serif; display:none;" id="hero_paragraph">Sign up below and you'll be the first to know when Scure becomes available!</p>
		  </p>
		<br>
